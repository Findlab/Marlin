...
#define TEMP_SENSOR_BED 9 // Bazi durumlarda 6 olabilir Epcos...
...
#define PIDTEMP
#define BANG_MAX 265 // limits current to nozzle while in bang-bang mode; 255=full current
#define PID_MAX 265 // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
#ifdef PIDTEMP
...
#define INVERT_Y_DIR true   // for Mendel set to true, for Orca set to true
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,2560,740}  // default steps per unit for Ultimaker
...
// #define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER //değiştirildi.
